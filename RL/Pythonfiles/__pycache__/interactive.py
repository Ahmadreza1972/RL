...
def print_board(status):
    ...
    board = [["1" if i == -1 else ("0" if i == 1 else " ") for i in row] for row in obs['cells']]
...
if __name__ == '__main__':
    assert os.path.exists(r"RL/Maze_LR Exported/model.jar"), r"Missing file 'Maze_LR Exported/model.jar'. To fix, create the folder if it does not exist and export/unzip in-place."
