...
import pandas as pd
# Load the image
image_path = "RL\solvew by python\maze.png"  # Update with your file path if necessary
...
sns.heatmap(matrix)
plt.show()
np.savetxt('RL\solvew by python\matrix_orginal.csv', matrix, delimiter=',', fmt='%d')